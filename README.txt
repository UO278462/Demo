...
a persistence unit "demoneitorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demoneitor/pom.xml":
...
artifact ("demoneitor.war") is already built. You can build
